...
func TestWithoutAudienceValidator_ValidateToken(t *testing.T) {
	const (
	...
	testCases := []struct {
		...
		},
		{
			...
			token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJodHRwczovL2dvLWp3dC1taWRkbGV3YXJlLmV1LmF1dGgwLmNvbS8iLCJzdWIiOiIxMjM0NTY3ODkwIiwiYXVkIjpbXSwiaWF0IjoxNjY2OTM3Njg2LCJuYmYiOjE2NjY5MzkwMDAsImV4cCI6OTY2NzkzNzY4Nn0.4GtcerqXHb3jvMVRKSWI87Dprp-GmCjKS46StY6GoMk",
			keyFunc: func(context.Context) (interface{}, error) {
				return []byte("secret"), nil
			},
			algorithm: HS256,
